...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        self.labelTitle=[[[UILabel alloc]initWithFrame:CGRectMake(10, 10, 180, 20)]autorelease];
        ...
        self.labelDate=[[[UILabel alloc]initWithFrame:CGRectMake(10, 30, 200, 10)]autorelease];
